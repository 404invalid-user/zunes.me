                                    ...
                                    <td className="XbcLayoutCell">
                                        <div className="XbcChrome">
                                            <div className="XbcWpFlash" style={{margin: 0}}>
                                                <p className="hero-text">welcome to the social</p>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                        ...
                                        <div className="XbcChrome" style={{width: 950}}>
                                            <div className="XbcWpFreeForm2" style={{margin: 0}}>
                                                <div className="cms_articlesubhead">
                                                    <p className="XbcAlignCenter">Join the small die-hard community dedicated to the legacy of the Zune</p>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                                                    ...
                                                                    <div className="XbcChrome">
                                                                        <div className="XbcWpFreeForm2"
                                                                            ...
                                                                            <table style={{border: 0}} cellPadding="0"
                                                                                ...
                                                                                <tr>
                                                                                    <td width="35">
                                                                                        <a href="http://social.zunes.me/redirect?type=hub&amp;id=newtozunestarthere">
                                                                                            <img
                                                                                                style={{alignSelf: "center"}}
                                                                                                alt="Image: Step 2"
                                                                                                height="25" width="25"
                                                                                    ...
                                                                                    <td>
                                                                                        <div style={{paddingBottom: 5}}>
                                                                                            <a className="hero_Link"
                                                                                               href="http://social.zunes.me/redirect?type=hub&amp;id=newtozunestarthere">
                                                                                                <strong>Read the refresher guide</strong>
                                                                                            </a>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                    ...
                                                                    <div className="XbcChrome">
                                                                        <div className="XbcWpFreeForm2"
                                                                            ...
                                                                            <table style={{border: 0}} cellPadding="0"
                                                                                ...
                                                                                <tr>
                                                                                    <td width="35"><a
                                                                                        href="https://live.zunes.me/account/buySubscription">
                                                                                        <img
                                                                                            style={{alignSelf: "center"}}
                                                                                            alt="Image: Step 3"
                                                                                            height="25" width="25"
                                                                                    ...
                                                                                    <td>
                                                                                        <div style={{paddingBottom: 5}}>
                                                                                            <a className="hero_Link"
                                                                                               href="https://live.zunes.me/account/buySubscription">
                                                                                                <strong>Chat with the community</strong>
                                                                                            </a>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                            ...
                                                                                            <td className="XbcLayoutCell">
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        style={{margin: "10px 0px 0px"}}>
                                                                                                        <p><strong>
                                                                                                            <a href="http://social.zunes.me/music">MUSIC</a>
                                                                                                        </strong></p>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </td>
                                                                                                    ...
                                                                                                    <td className="XbcLayoutCell">
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <p>
                                                                                                                    <strong><a
                                                                                                                        href="http://social.zunes.me/movies">MOVIES
                                                                                                                    </a></strong>
                                                                                                                </p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <table
                                                                                                                    ...
                                                                                                                    <tr style={{
                                                                                                                        ...
                                                                                                                        <td width="75">
                                                                                                                            <a href="http://social.zunes.me/MOVIES/0/ACF3B423-E4FE-46D0-8582-82C6C2D9E79C">
                                                                                                                                <img
                                                                                                                        ...
                                                                                                                        <td width="155">
                                                                                                                            <p>
                                                                                                                                <a className="linkgray"
                                                                                                                                   href="http://social.zunes.me/MOVIES/0/ACF3B423-E4FE-46D0-8582-82C6C2D9E79C">
                                                                                                                                    <strong>Conan
                                                                                                                                        The
                                                                                                                                        Barbarian</strong>
                                                                                                                                </a><br/>
                                                                                                                                <a className="linkgray"
                                                                                                                                   href="http://social.zunes.me/MOVIES/0/ACF3B423-E4FE-46D0-8582-82C6C2D9E79C">Lionsgate</a>
                                                                                                                            </p>
                                                                                                                            <p>&nbsp;</p>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                    ...
                                                                                                    <td className="XbcLayoutCell">
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <p>
                                                                                                                    <strong>
                                                                                                                        <a href="http://web.archive.org/web/20111130221814/http://social.zunes.me/tv/">TV</a>
                                                                                                                    </strong>
                                                                                                                </p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <table
                                                                                                                    ...
                                                                                                                    <tr style={{
                                                                                                                        ...
                                                                                                                        <td width="75">
                                                                                                                            <a href="http://social.zunes.me/TV/SERIES/THE-WALKING-DEAD/52F36FC1-6FF4-4418-A432-252BBAF93861">
                                                                                                                                <img
                                                                                                                                    alt="Image: Grimm"
                                                                                                                                    height="70"
                                                                                                                                    width="70"
                                                                                                                        ...
                                                                                                                        <td width="155">
                                                                                                                            <a className="linkgray"
                                                                                                                               href="http://social.zunes.me/TV/SERIES/THE-WALKING-DEAD/52F36FC1-6FF4-4418-A432-252BBAF93861">
                                                                                                                                <strong>The
                                                                                                                                    Walking
                                                                                                                                    Dead</strong>
                                                                                                                            </a><br/>
                                                                                                                            <a className="linkgray"
                                                                                                                               href="http://social.zunes.me/TV/SERIES/THE-WALKING-DEAD/52F36FC1-6FF4-4418-A432-252BBAF93861">AMC</a>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    </tbody>
                                                                                                                </table>
