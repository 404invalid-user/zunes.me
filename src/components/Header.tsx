                                ...
                                <ul className="menu">
                                    <li>
                                        <a id="ctl00__headerControl__signInHyperlink" className="zuneTag"
                                           href="https://live.zunes.me/signin.ashx?ru=http%3a%2f%2flocalhost:3001%2fhome">
                                            sign in
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <div className="TopNav">
                        <ul className="menu">
                            ...
                            <li className="music" onPointerEnter={event => this.XbcNav_mainOver(event)}
                                onPointerLeave={event => this.XbcNav_mainOut(event)}>
                                <a href="https://social.zunes.me/music/">music</a>
                                <ul className="events" style={{left: "84.225px", top: "39px"}}>
                                    <div style={{float: "left"}}>
                                        <li><a href="https://social.zunes.me/music/genre/rock">rock</a></li>
                                        <li><a href="https://social.zunes.me/music/genre/hiphop">hip hop</a></li>
                                        <li><a href="https://social.zunes.me/music/genre/rb">r&amp;b; / soul</a></li>
                                        <li><a href="https://social.zunes.me/music/genre/country">country</a></li>
                                        <li><a href="https://social.zunes.me/music/genre/pop">pop</a></li>
                                        <li><a href="https://social.zunes.me/music/playlists">playlists</a></li>
                                    </div>
                                    <div style={{float: "left"}}>
                            ...
                            <li className="video" onPointerEnter={event => this.XbcNav_mainOver(event)}
                                onPointerLeave={event => this.XbcNav_mainOut(event)}>
                                <a href="https://social.zunes.me/video">video</a>
                                <ul className="events" style={{left: 144.238, top: 39}}>
                                    <div style={{float: "left"}}>
                                        <li><a href="https://social.zunes.me/tv">tv</a></li>
                                        <li><a href="https://social.zunes.me/movies">movies</a></li>
                                        <li><a href="https://social.zunes.me/movietrailers">movie trailers</a></li>
                                    </div>
                                    <div style={{float: "left"}}>
                            ...
                            <li className="podcasts" onPointerEnter={event => this.XbcNav_mainOver(event)}
                                onPointerLeave={event => this.XbcNav_mainOut(event)}>
                                <a href="https://social.zunes.me/podcasts/">podcasts</a>
                                <ul className="events" style={{left: 201.788, top: 39}}>
                                    <div style={{float: "left"}}>
                                        <li><a
                                            href="https://social.zunes.me/podcasts/genre/pod.arts">arts</a></li>
                                        <li><a
                                            href="https://social.zunes.me/podcasts/genre/pod.business">business</a></li>
                                        <li><a
                                            href="https://social.zunes.me/podcasts/genre/pod.education">education</a></li>
                                        <li><a
                                            href="https://social.zunes.me/podcasts/genre/pod.entertainment">entertainment</a></li>
                                        <li><a
                                            href="https://social.zunes.me/podcasts/genre/pod.health">health</a></li>
                                    </div>
                                    <div style={{float: "left"}}>
                    ...
                    <div id="ctl00__headerControl__searchBoxPanel">
                        <div className="HeaderSearch">
                            <form onSubmit={(event) => this.doHeaderSearch(event)}
                                  action="http://social.zunes.me/search.aspx">
